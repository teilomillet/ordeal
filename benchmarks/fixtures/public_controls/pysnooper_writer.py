"""Fixed sibling of the BugsInPy PySnooper bug 3 reproduction.
...
def write_to_path(output: Literal["trace.log"]) -> dict[str, str]:
    """Create and invoke the fixed path-output writer closure."""

    def write(text: str) -> dict[str, str]:
        with _memory_open(output, "a") as output_file:
